    ...
    window.onload=function(){
        ...
        cart.forEach(id=>{
            ...
            container.innerHTML+=`<div class="summary-item"><div class="summary-item-img" style="background-image:url('${p.img}')"></div><div class="summary-item-title">${p.title}</div><div class="summary-item-price">¥${p.price.toLocaleString()}</div></div>`;
        });
