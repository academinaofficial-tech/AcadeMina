    ...
    <main>
      <section className="relative h-[92vh] flex items-center px-5 md:px-10 text-white bg-[#333] bg-[linear-gradient(rgba(0,0,0,0.35),rgba(0,0,0,0.35)),url('/images/hero.png')] bg-cover bg-center mt-20 md:mt-[134px]">
        <div className="max-w-[1200px] w-full mx-auto">
          <h1 className="text-[2.8rem] md:text-[4.5rem] leading-[1.1] font-extrabold mb-[30px] tracking-[-0.02em]">
      ...
      <section className="w-full" id="services" aria-label="サービス紹介">
      ...
      <section className="px-5 md:px-10 py-[100px] max-w-[1200px] w-full mx-auto" id="column" aria-label="コラム記事">
      ...
      <div className="w-full bg-[#fafafa]">
        <section className="px-5 md:px-10 py-[100px] max-w-[1200px] w-full mx-auto" id="news" aria-label="ニュース">
          <div className="flex justify-between items-end mb-10 border-b-2 border-text pb-5">
